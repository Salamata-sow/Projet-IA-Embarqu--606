...
Next, this program can be run in boot from flash mode. This can be done by following the instructions below:
 ...
 - Resort to CubeProgrammer to add a header to the generated binary Nx_TCP_Echo_Client.bin with the following command
   ...
   - The resulting binary is Nx_TCP_Echo_Client-trusted.bin.
